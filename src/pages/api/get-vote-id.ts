...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error("Vote ID fetch error:", error)
    return res.status(500).json({ error: "Failed to fetch vote ID" })
  }
} 